      ...
      <div v-show="flags.updateInProgress || (connected && info !== null && this.info.storage_databases_present && flags.rpcActive && info.hardware_name)" class="device-screen column">
        <div class="flex">
          <div class="info">
            <p>
              <span>Firmware:</span>
              <span>{{ info.firmware_version !== 'unknown' ? info.firmware_version : info.firmware_commit }} {{ info.firmware_build_date }}</span>
            </p>
            <p>
              <span>SD card:</span>
            ...
            <p>
              <span>Radio FW:</span>
              <span>{{ info.radio_alive !== false ? info.radio_stack_major + '.' + info.radio_stack_minor + '.' + info.radio_stack_sub : 'corrupt' }} {{ radioStackType }}</span>
            </p>
          </div>
